package advancedweb.project.welfareservice.global.exception;
...
@Slf4j
@Hidden
@RestControllerAdvice(annotations = {RestController.class}, basePackages = {"advancedweb.project.welfareservice.ui.controller"})
